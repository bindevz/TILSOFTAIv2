...
public static class AddTilsoftAiSqlExtensions
{
    public static IServiceCollection AddTilsoftAiSql(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<SqlCapabilityCatalogRepository>();
        services.AddSingleton<ISqlBackedCapabilityCatalog>(sp => sp.GetRequiredService<SqlCapabilityCatalogRepository>());
        services.AddSingleton<ICapabilityCatalogReloader>(sp => sp.GetRequiredService<SqlCapabilityCatalogRepository>());
        services.AddSingleton<ICapabilityRegistry>(sp => sp.GetRequiredService<SqlCapabilityCatalogRepository>());
        services.AddSingleton<ICapabilityMetadataRepository>(sp => sp.GetRequiredService<SqlCapabilityCatalogRepository>());
