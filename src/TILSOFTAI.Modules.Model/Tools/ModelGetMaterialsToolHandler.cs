...
public sealed class ModelGetMaterialsToolHandler : ModelToolHandlerBase, IToolHandler
{
    public ModelGetMaterialsToolHandler(ISqlExecutor sqlExecutor) : base(sqlExecutor)
    {
    }
