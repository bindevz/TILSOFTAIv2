...
public sealed class ModelGetPackagingToolHandler : ModelToolHandlerBase, IToolHandler
{
    public ModelGetPackagingToolHandler(ISqlExecutor sqlExecutor) : base(sqlExecutor)
    {
    }
