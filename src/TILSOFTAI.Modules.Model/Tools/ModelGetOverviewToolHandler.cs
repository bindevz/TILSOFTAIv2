...
public sealed class ModelGetOverviewToolHandler : ModelToolHandlerBase, IToolHandler
{
    public ModelGetOverviewToolHandler(ISqlExecutor sqlExecutor) : base(sqlExecutor)
    {
    }
