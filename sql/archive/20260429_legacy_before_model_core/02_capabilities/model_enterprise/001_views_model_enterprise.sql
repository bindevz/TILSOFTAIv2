...
-- ============================================================================
-- Model Enterprise Views
-- Guard: Only create if ERP Model table exists
--
-- These views depend on the ERP database tables (dbo.Model, dbo.ModelPiece,
-- dbo.ModelPackagingMethodOption, dbo.ModelMaterialConfig, dbo.ProductWizardSection).
-- On fresh TILSOFTAI databases without ERP data, these objects are skipped.
--
-- We use sp_executesql with IF guard to fully defer DDL compilation.
-- ============================================================================

IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'Model' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    PRINT 'Skipping model_enterprise views: dbo.Model table not found (ERP base table required).';
    PRINT 'This is expected on fresh databases without ERP data.';
END
ELSE
BEGIN
    PRINT 'Creating model_enterprise views...';
    ...
    ';
    PRINT '  Created: dbo.v_Model_Overview';
    ...
    ';
    PRINT '  Created: dbo.v_Model_Pieces';
    ...
    ';
    PRINT '  Created: dbo.v_Model_Packaging_Default';
    ...
    LEFT JOIN dbo.ProductWizardSection AS pws
        ON pws.ProductWizardSectionID = mmc.ProductWizardSectionID;
    ';
    PRINT '  Created: dbo.v_Model_Materials';
    
    PRINT 'Model enterprise views created.';
END
GO
