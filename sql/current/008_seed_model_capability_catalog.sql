...
USING (VALUES
    (N'model.count', N'{"maxRowsForChat":20,"maxRowsForAiSummary":20,"allowAiSummary":false}'),
    (N'model.overview.by-code', N'{"maxRowsForChat":20,"maxRowsForAiSummary":20,"allowAiSummary":false}'),
    (N'model.pieces.by-code', N'{"maxRowsForChat":20,"maxRowsForAiSummary":20,"allowAiSummary":false}'),
    (N'model.materials.by-code', N'{"maxRowsForChat":20,"maxRowsForAiSummary":20,"allowAiSummary":false}'),
    (N'model.compare', N'{"maxRowsForChat":20,"maxRowsForAiSummary":20,"allowAiSummary":false}'),
    (N'model.packaging.by-code', N'{"maxRowsForChat":20,"maxRowsForAiSummary":20,"allowAiSummary":false}')
